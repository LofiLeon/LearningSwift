...
//  CupcakeCorner
//
//  Created by Leon Grimmeisen on 29.03.22.
//

import SwiftUI

struct ContentView: View {
    // This is the only place where a Order will be created -> @StateObject
    // Other screens will use @ObservedObject
    ...
    var body: some View {
        NavigationView {
            ...
            .navigationTitle("Cupkake Corner")
        }
        .background(.red)
    }
}
