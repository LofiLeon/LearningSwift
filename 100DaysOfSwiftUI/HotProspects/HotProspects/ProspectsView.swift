...
struct ProspectsView: View {
    ...
    // This find prospects class in environment; attach it to local prospects property;
    // watch for changes and reinvoke body property
    ...
    var body: some View {
        NavigationView {
                ...
                ForEach(filteredProspects) { prospect in
                    HStack {
                        ...
                        if prospect.twitterHandle != "" {
                            ...
                            .onTapGesture() {
                                UIApplication.shared.open(URL(string: "https://twitter.com/\(prospect.twitterHandle)")!)
                            }
                        }
            ...
            .sheet(isPresented: $isShowingScanner) {
                CodeScannerView(codeTypes: [.qr], simulatedData: "Leon Grimmeisen\ngrimmeisen@leon.com", completion: handleScan)
            }
    ...
    func handleScan(result: Result<ScanResult, ScanError>) {
        ...
        case .success(let result):
            ...
            person.twitterHandle = details[2]
